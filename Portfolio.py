...
#Stock plots
plt.plot(date_df, aapl_df, label = 'AAPL' )
plt.plot(date_df1, acls_df, label = 'ACLS')
plt.plot(date_df2, adbe_df, label = 'ADBE')
plt.plot(date_df3, amat_df, label = 'AMAT')
plt.plot(date_df4, amzn_df, label = 'AMZN')
plt.plot(date_df5, arnc_df, label = 'ARNC')
plt.plot(date_df6, avx_df, label = 'AVX')
plt.plot(date_df, awx_df, label = 'AWX')
plt.plot(date_df, bep_df, label = 'BEP')
plt.plot(date_df, csbr_df, label = 'CSBR')
plt.plot(date_df, cvy_df, label = 'CVY')
plt.plot(date_df, d_df, label = 'D')
plt.plot(date_df, dem_df, label = 'DEM')
plt.plot(date_df, des_df, label = 'DES')
plt.plot(date_df, dew_df, label = 'DEW')
plt.plot(date_df, dfe_df, label = 'DFE')
plt.plot(date_df, dgs_df, label = 'DGS')
plt.plot(date_df, dhs_df, label = 'DHS')
plt.plot(date_df, dln_df, label = 'DLN')
